        ...
        <Empty
          description={
            <FormattedMessage
              ...
              description={
                'Empty state for the events tab in the model trace explorer. ' +
                'Events are logs of arbitrary things (e.g. exceptions) that occur during the execution of ' +
                'a span, and can be user-defined.'
              }
            />
          }
        />
            ...
            {Object.keys(attributes).map((attribute) => {
              ...
              return (
                <ModelTraceExplorerCodeSnippet
                  ...
                  containsActiveMatch={isActiveMatchSpan && activeMatch.section === 'events' && activeMatch.key === key}
