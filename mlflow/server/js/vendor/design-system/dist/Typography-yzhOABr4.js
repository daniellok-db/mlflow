...
const getShadows = isDarkMode => {
  return isDarkMode ? {
    inner: `0px 1.5px 2px 0px ${blackAlpha45} inset, 0px 1.5px 2px 0px ${blackAlpha26} inset`,
    ...
    inner: `0px 1.5px 2px 0px ${blackAlpha05} inset, 0px 1.5px 2px 0px ${blackAlpha02} inset`,
...
export { useAntDConfigProviderContext as $, Arrow as A, Button as B, CloseIcon as C, DesignSystemAntDConfigProvider as D, LoadingIcon as E, Title as F, AccessibleContainer as G, ChevronLeftIcon as H, Icon as I, DU_BOIS_ENABLE_ANIMATION_CLASSNAME as J, lightColorList as K, LoadingState as L, getDefaultStyles as M, getPrimaryStyles as N, getDisabledSplitButtonStyles as O, getButtonEmotionStyles as P, DesignSystemEventProvider as Q, RestoreAntDDefaultClsPrefix as R, Spinner as S, Trigger as T, useDesignSystemEventSuppressInteractionContext as U, DesignSystemThemeContext as V, WarningIcon as W, DesignSystemContext as X, DesignSystemThemeProvider as Y, DesignSystemProvider as Z, ApplyDesignSystemFlags as _, useDesignSystemTheme as a, WithDesignSystemThemeHoc as a0, NewWindowIcon as a1, LoadingStateContext as a2, Popover as a3, getTypographyColor as a4, getBottomOnlyShadowScrollStyles as a5, ColorVars as a6, primitiveColors as a7, useFormContext as a8, Form as a9, DEFAULT_SPACING_UNIT as aa, DesignSystemEventProviderAnalyticsEventTypes as b, useDesignSystemEventComponentCallbacks as c, DesignSystemEventProviderComponentTypes as d, addDebugOutlineStylesIfEnabled as e, useNotifyOnFirstView as f, getAnimationCss as g, addDebugOutlineIfEnabled as h, useDesignSystemSafexFlags as i, getDarkModePortalStyles as j, useUniqueId as k, Root as l, Content as m, ChevronRightIcon as n, DesignSystemEventSuppressInteractionProviderContext as o, DesignSystemEventSuppressInteractionTrueContextValue as p, Typography as q, importantify as r, safex as s, CheckIcon as t, useDesignSystemContext as u, visuallyHidden as v, getValidationStateColor as w, ApplyDesignSystemContextOverrides as x, getShadowScrollStyles as y, DangerIcon as z };
//# sourceMappingURL=Typography-yzhOABr4.js.map
