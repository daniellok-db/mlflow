...
class Mutation(MutationType):
    ...
    # Override to exclude mlflow_search_runs from mutations
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # Remove mlflow_search_runs from mutations since we moved it to queries
        if hasattr(self, 'mlflow_search_runs'):
            delattr(self, 'mlflow_search_runs')
